...
# json 데이터 읽기(Read)
print(g_json_big_data[0]['레벨 1. CSV-1 키'])
print(g_json_big_data[1]['레벨 1. CSV-3 키']['레벨 3-1 키'])
# json 데이터 삽입
g_json_big_data.append({"레벨 1. CSV-4 키" : "수박"})
print(g_json_big_data)
# json 데이터 수정
g_json_big_data[0]['레벨 1. CSV-1 키'] = "체리"
# json 데이터 삭제
...
# {"키" : 1 , "몸무게" } -> key로 접근
# [{},{},{},{}] -> 인덱스로 접근
print(g_json_big_data[1]["레벨 1. CSV-3 키"]["레벨 3-1 키"][0]["레벨 4-1 키"])
g_json_big_data[1]["레벨 1. CSV-3 키"]["레벨 3-1 키"][0]["레벨 4-1 키"] = 24 # int형은 "" 안하게
