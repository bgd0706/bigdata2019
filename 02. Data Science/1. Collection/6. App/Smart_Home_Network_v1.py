...
def control_device() :
    global g_Radiator, g_Gas_Valve, g_Balcony_Windows, g_Door, g_lamp
...
def ai_person_info() :
    global g_Gas_Valve, g_Door, g_lamp, g_speaker, g_ref
...
# f_lamp_TV = open('lamp_TV.csv', 'w', newline='')
# f_lamp_TV_w = csv.writer(f_lamp_TV)
# f_lamp_TV_w.writerow([4501])
# f_lamp_Book = open('lamp_Book.csv', 'w', newline='')
# f_lamp_Book_w = csv.writer(f_lamp_Book)
# f_lamp_Book_w.writerow([2701])
# f_lamp_Music = open('lamp_Music.csv', 'w', newline='')
# f_lamp_Music_w = csv.writer(f_lamp_Music)
# f_lamp_Music_w.writerow([3001])
...
while True :
    ...
    if(menu_num == 1) :
        ...
        behavior = int(input("현재 당신은 무엇을 하고 있습니까? (1. 기상 2. 출근/외출 3. 식사 4. 목욕 5. TV 보기 6. 음악"
                             "7. 독서 8. 수면) "))
